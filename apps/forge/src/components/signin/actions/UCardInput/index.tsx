    ...
    return (
        <>
            <Card className="w-[700px]">
                ...
                <CardContent>
                    <OtpInput ref={otpRef} length={UCARD_LENGTH} stripChars={STRIP_CHAR_AMOUNT}
                              onOtpChange={handleOtpChange} onSubmit={handleOnSubmit}/>
                </CardContent>
                <CardFooter className="flex justify-between flex-row-reverse">
                    <Button onClick={() => handleOnSubmit(otp)} disabled={!isOtpValid} aria-disabled={!isOtpValid}>Submit</Button>
