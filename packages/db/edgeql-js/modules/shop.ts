...
const $Dimension = $.makeType<$Dimension>(_.spec, "8697c12e-bfc7-11f0-8b0e-41a02c9090d6", _.syntax.literal);
...
const $Item = $.makeType<$Item>(_.spec, "b8e10d98-bfc7-11f0-84e9-e5caffbad242", _.syntax.literal);
...
const $LineItem = $.makeType<$LineItem>(_.spec, "b8eef886-bfc7-11f0-846f-f3c811a06698", _.syntax.literal);
...
const $Module = $.makeType<$Module>(_.spec, "b8f3a2be-bfc7-11f0-b5ee-65c3f7f4d9bc", _.syntax.literal);
...
const $Purchase = $.makeType<$Purchase>(_.spec, "b6316a0c-bfc7-11f0-9216-7b7237a8eefc", _.syntax.literal);
...
const $Skew = $.makeType<$Skew>(_.spec, "b8e45188-bfc7-11f0-bde1-4384fb17c144", _.syntax.literal);
