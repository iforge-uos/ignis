...
export const appLinks: AppLink[] = [
  ...
  { app: "Sign In", displayName: "Home", path: "/sign-in", index: 0, id: "sign_in_root" },
  {
    app: "Sign In",
  ...
  },
  {
    ...
    children: [
      ...
      { app: "Sign In", displayName: "Sign Out", path: "/sign-in/actions/out", id: "sign_in_actions_out", index: 1 },
      {
        app: "Sign In",
        displayName: "Register",
        path: "/sign-in/actions/register",
        id: "sign_in_actions_register",
        index: 2,
      },
      {
        app: "Sign In",
        ...
        id: "sign_in_actions_enqueue",
        index: 3,
      },
    ],
  },
  { app: "Sign In", displayName: "Dashboard", path: "/sign-in/dashboard", index: 3, id: "sign_in_dashboard" },
