...
import { ManageUserWidgetProps } from "/src/routes/_authenticated/_reponly/sign-in.$location/dashboard/-components/SignedInUserCard/ManageUserWidget";
            ...
            render={({ field }) => (
              <FormItem className="space-y-4">
                ...
                <FormMessage className="bg-info text-info-foreground p-2 text-balance">
                  By clicking submit you will change the user to either become a rep with those teams, or modify a reps
                  existing teams to match the current selection.
                </FormMessage>
              </FormItem>
            )}
          />
