...
export namespace auth {
  export interface BlacklistedToken extends std.$Object {
    "expires": Date;
    "token": string;
  }
  export interface Permission extends std.$Object {
...
export interface types {
  ...
  "auth": {
    ...
    "PermissionAction": auth.PermissionAction;
    "PermissionSubject": auth.PermissionSubject;
    "Role": auth.Role;
  };
  "cfg": {
