...
import {SearchCheckIcon, TriangleAlert} from "lucide-react";
    ...
    return (
        <>
            ...
            <div className="p-4 mt-1">
                ...
                <div
                    className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 justify-items-center mx-auto min-h-72 max-w-[1440px]">
                ...
                <div
                    className="grid grid-cols-1 sm:grid-cols-2 gap-4 justify-items-center mx-auto min-h-72 max-w-[1440px]">
                            ...
                            <IndexCard
                                img={
                                    <ImageGradient gradientColor="cross">
                                        <img src={`${import.meta.env.VITE_CDN_URL}/files/risk_assessments.jpg`}
                                             alt="Risk Assessment"/>
                                    </ImageGradient>
                                }
                                title={
