...
const Name: $Name = $.makeType<$Name>(_.spec, "3717f2de-3c38-11f1-8b2c-df83324c645c", _.syntax.literal);
...
const $Team = $.makeType<$Team>(_.spec, "e4dc3430-3c37-11f1-82b8-43abba21cbfe", _.syntax.literal);
