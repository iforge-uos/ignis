...
export function AgreementCard({ agreement }: AgreementCardProps) {
  ...
  return (
      <TooltipProvider>
        ...
        >
          <Card
              className="bg-card dark:bg-card-dark border-border dark:border-border-dark overflow-hidden group w-full h-full">
            <CardContent className="p-0 relative w-full h-full">
              ...
              <div className="flex flex-col w-full h-full">
                ...
                <div
                    className="w-full bg-popover dark:bg-popover-dark p-4 sm:p-6 flex flex-col justify-center items-center">
                  {status === "Not Signed" ? (
                      <Tooltip>
                        <TooltipTrigger>
