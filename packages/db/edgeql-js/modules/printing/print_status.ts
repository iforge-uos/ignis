...
const FailureReason: $FailureReason = $.makeType<$FailureReason>(_.spec, "3717c048-3c38-11f1-81c4-97a47502b6b0", _.syntax.literal);
...
const $Cancelled = $.makeType<$Cancelled>(_.spec, "6522fd18-3c38-11f1-9085-3723e927d2be", _.syntax.literal);
...
const $Complete = $.makeType<$Complete>(_.spec, "65242ae4-3c38-11f1-a62a-b109b7ed3739", _.syntax.literal);
...
const $Failed = $.makeType<$Failed>(_.spec, "65253146-3c38-11f1-96b5-c38e3101c8b4", _.syntax.literal);
...
const $Printing = $.makeType<$Printing>(_.spec, "65265d1e-3c38-11f1-9eaf-25beaa22785c", _.syntax.literal);
...
const $Queued = $.makeType<$Queued>(_.spec, "6527c83e-3c38-11f1-9621-d38577eac6b4", _.syntax.literal);
