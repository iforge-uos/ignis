...
import { Command, CommandGroup, CommandItem, CommandList } from "@packages/ui/components/command";
...
const MultipleSelector = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "border-input placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-ring/50 dark:bg-input/30 dark:hover:bg-input/50 border bg-transparent text-sm whitespace-nowrap shadow-xs transition-[color,box-shadow] outline-none focus-visible:ring-[3px]",
