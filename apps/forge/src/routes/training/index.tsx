  ...
  return (
    <>
      ...
      <div className="p-4 mt-1">
        <h1 className="text-4xl font-bold tracking-wide sm:text-5xl md:text-6xl text-center">
        ...
        <h4 className="text-4xl font-semibold mb-4 text-center">Locations</h4>
        ...
        <Separator className="my-6" />
        <h3 className="text-4xl font-semibold text-center m-4">Useful Links</h3>
