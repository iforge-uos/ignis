...
import { DiscordIcon, InstagramIcon, LinkedInIcon, TwitterIcon, YouTubeIcon } from "@/components/icons/Socials";
...
const socialMediaLinks = [
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/@iforge_uos",
    icon: <YouTubeIcon />,
  },
  {
    name: "Twitter",
    href: "https://twitter.com/iForgeUoS",
    icon: <TwitterIcon />,
  },
  {
    name: "LinkedIn",
  ...
  {
    name: "Discord",
    href: "https://discord.gg/UK6e8GeArH",
    icon: <DiscordIcon />,
  },
] satisfies {
  name: string;
    ...
    <div className="container mx-auto py-10 px-4 md:px-6">
      <div className="space-y-12">
        <div className="text-center">
          ...
          <div className="h-1 w-20 bg-primary mx-auto mt-4 mb-6" />
        </div>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Reach out to our general inbox</CardDescription>
              </CardHeader>
              <CardContent>
                <a
  ...
  return (
    <Card className="h-full flex flex-col">
      <div className="bg-primary/10 p-4 flex items-center gap-4">
        <div className="flex h-12 w-12 items-center justify-center rounded-full text-primary rounded-lg">{icon}</div>
...
function SocialLink({ href, icon, name }: (typeof socialMediaLinks)[number]) {
  return (
    <Link href={href} className="flex flex-col items-center gap-2 p-3 rounded-lg">
      <div className="h-10 w-10 flex items-center justify-center rounded-full bg-primary/10 text-primary">{icon}</div>
