...
export const LOCATIONS: readonly Location[] = ["mainspace", "heartspace"];
export const REP_ON_SHIFT = "Rep On Shift";
export const REP_OFF_SHIFT = "Rep Off Shift";
export const INFRACTION_TYPES: InfractionType[] = ["WARNING", "TEMP_BAN", "PERM_BAN", "RESTRICTION", "TRAINING_ISSUE"];
