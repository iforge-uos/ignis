...
export function WelcomeEmail({ display_name = "{display-name}", id = "0000-0000-0000-0000" }: PartialUser) {
  return (
    <Email
    ...
    >
      ...
      <Container>
        ...
        <ul>
          <li>
            <Text>
              Set up your profile <Link href={`${process.env.FRONT_END_URL}/user`}>here</Link>.
            </Text>
          </li>
          <li>
            <Text>
              Start a new project or <Link href="https://iforgesheffield.org/user-projects/">get some inspiration</Link>
              .
            </Text>
          </li>
          <li>
