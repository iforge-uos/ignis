...
const Selectability: $Selectability = $.makeType<$Selectability>(_.spec, "86724c64-bfc7-11f0-a7ae-455b4b44136c", _.syntax.literal);
...
const Status: $Status = $.makeType<$Status>(_.spec, "8672740a-bfc7-11f0-b404-c317125907b1", _.syntax.literal);
...
const $Booking = $.makeType<$Booking>(_.spec, "b60ed866-bfc7-11f0-8934-71ecd24e28c6", _.syntax.literal);
...
const $Tool = $.makeType<$Tool>(_.spec, "fa74f954-bfc7-11f0-94a4-bd58a3f0663f", _.syntax.literal);
