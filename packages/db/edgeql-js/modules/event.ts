...
const Type: $Type = $.makeType<$Type>(_.spec, "e4e0f448-3c37-11f1-b8e1-5d3d1d9293a2", _.syntax.literal);
...
const $Event = $.makeType<$Event>(_.spec, "e4e10db6-3c37-11f1-9e10-419f6b53a42c", _.syntax.literal);
