CREATE MIGRATION m1zgetwllivftpdkj6igyxp5widaohko7vcvv3ozy3svcngflqampa
    ONTO m1gu4qrigpxtdw75jvdoyu7u2hvac4tqfa2nmsxqoxcyef2pe5g3zq
{
      ...
      UNION 
          ((WITH
              ...
              training_in_person_done := 
                  EXISTS (user_with_training.training@in_person_created_at)
              ,
              training_revoked := 
                  EXISTS (user_with_training.training@infraction)
              ,
              training_expired := 
                  false
              ,
              ...
              ,
              rep_online := 
                  EXISTS (linked_rep_training.training@created_at)
              ,
              rep_in_person_needed := 
                  (training.rep.in_person ?? false)
              ,
              rep_in_person_done := 
                  EXISTS (linked_rep_training.training@in_person_created_at)
              ,
              rep_revoked := 
                  EXISTS (linked_rep_training.training@infraction)
              ,
              rep_expired := 
                  false
          SELECT
