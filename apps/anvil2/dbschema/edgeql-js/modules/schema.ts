...
export type $ObjectTypeλShape = $.typeutil.flatten<$SourceλShape & Omit<$ConsistencySubjectλShape, "<subject"> & $InheritingObjectλShape & Omit<$TypeλShape, "<target"> & $AnnotationSubjectλShape & {
  ...
  "<__type__[is auth::Permission]": $.LinkDesc<_auth.$Permission, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is auth::Role]": $.LinkDesc<_auth.$Role, $.Cardinality.Many, {}, false, false,  false, false>;
  ...
  "<__type__[is auth::BlacklistedToken]": $.LinkDesc<_auth.$BlacklistedToken, $.Cardinality.Many, {}, false, false,  false, false>;
  ...
  "<__type__[is notification::Target]": $.LinkDesc<_notification.$Target, $.Cardinality.Many, {}, false, false,  false, false>;
