...
export type GetUserTrainingForSignInArgs = {
  "location": ("MAINSPACE" | "HEARTSPACE");
  "on_shift_reasons": string[];
  "location_": ("MAINSPACE" | "HEARTSPACE" | "GEORGE_PORTER");
  "id": string;
};
...
export async function getUserTrainingForSignIn(client: Executor, args: GetUserTrainingForSignInArgs): Promise<GetUserTrainingForSignInReturns> {
