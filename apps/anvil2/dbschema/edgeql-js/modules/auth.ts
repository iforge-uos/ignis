...
const PermissionAction: $PermissionAction = $.makeType<$PermissionAction>(_.spec, "330fdae4-8a32-11ef-a38f-0d79d266cf2e", _.syntax.literal);
...
const PermissionSubject: $PermissionSubject = $.makeType<$PermissionSubject>(_.spec, "330fe2be-8a32-11ef-9306-8d6a9368252a", _.syntax.literal);
...
const $BlacklistedToken = $.makeType<$BlacklistedToken>(_.spec, "332e38d6-8a32-11ef-88a9-43abd215ba8d", _.syntax.literal);
...
const $Permission = $.makeType<$Permission>(_.spec, "330fedf4-8a32-11ef-9765-8fb0dcbc42f2", _.syntax.literal);
...
const $Role = $.makeType<$Role>(_.spec, "33110c52-8a32-11ef-9f4d-1146eeb93c18", _.syntax.literal);
